...
namespace ServiceModel.Grpc.Internal
{
    ...
    public partial class GrpcServiceClientBuilderTest
    {
        ...
        public void OneParameterContext()
        {
            ...
            _factory().OneParameterContext(3, options);
        ...
        public async Task ConcatThreeValueAsync()
        {
            ...
            var actual = await _factory().ConcatThreeValueAsync(1, "a", 2, _tokenSource.Token);
        ...
        [Test]
        public async Task EmptyClientStreaming()
        {
            Console.WriteLine(_factory().GetType().InstanceMethod(nameof(IContract.EmptyClientStreaming)).Disassemble());
            ...
            await _factory().EmptyClientStreaming(new[] { 1, 2 }.AsAsyncEnumerable());
