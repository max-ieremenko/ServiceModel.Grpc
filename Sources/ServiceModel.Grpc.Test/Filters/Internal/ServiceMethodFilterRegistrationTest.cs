...
namespace ServiceModel.Grpc.Filters.Internal
{
    ...
    public class ServiceMethodFilterRegistrationTest
    {
        ...
        public void BeforeEachTest()
        {
            ...
            _contractMethodDefinition = typeof(IMultipurposeService).InstanceMethod(nameof(IMultipurposeService.Sum5ValuesAsync));
        ...
        public void GlobalFilters()
        {
            ...
            for (var i = 0; i < 2; i++)
            {
                ...
                actual.ContractMethodDefinition.ShouldBe(_contractMethodDefinition);
