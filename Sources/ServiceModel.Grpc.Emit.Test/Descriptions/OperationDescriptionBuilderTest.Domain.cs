...
public partial class OperationDescriptionBuilderTest
{
    ...
    private sealed class ResponseTypeCases
    {
        ...
        [OperationContract]
        [ResponseType(typeof(Message<string>))]
        [HeaderResponseType(typeof(Message<string, int>), [0, 2], 1)]
        ...
        [OperationContract]
        [ResponseType(typeof(Message<string>))]
        [HeaderResponseType(typeof(Message<int>), [1], 0)]
    ...
    private sealed class RequestTypeCases
    {
        ...
        [OperationContract]
        [RequestType(typeof(Message<int>), [0])]
        ...
        [OperationContract]
        [RequestType(typeof(Message<int>), [2])]
        [HeaderRequestType(typeof(Message<int, string>), [0, 1])]
    ...
    {
        public ResponseHeaderNamesAttribute(params string[] names)
        {
            Names = names;
        }
    ...
    private sealed class ResponseHeaderNamesCases
    {
        [ResponseHeaderNames("R1", "R2")]
        public ValueTask<(IAsyncEnumerable<double> Stream, int R1, string R2)> Case1() => throw new NotImplementedException();

        [ResponseHeaderNames("R1", "R2")]
        public ValueTask<(int R1, IAsyncEnumerable<double> Stream, string R2)> Case2() => throw new NotImplementedException();

        [ResponseHeaderNames("Item1", "Item2")]
#pragma warning disable SA1414 // Tuple types in signatures should have element names
        public ValueTask<(int, IAsyncEnumerable<double>, string)> Case3() => throw new NotImplementedException();
