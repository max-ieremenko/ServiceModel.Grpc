...
internal sealed class CSharpServiceBinderBaseBindProviderBuilder : CodeGeneratorBase
{
    private readonly ContractDescription _contract;
    private readonly bool _isStaticClass;

    public CSharpServiceBinderBaseBindProviderBuilder(ContractDescription contract, bool isStaticClass)
    {
        _contract = contract;
        _isStaticClass = isStaticClass;
    }

    public override string GetGeneratedMemberName() => "BinderBaseBindProvider" + _contract.BaseClassName;
