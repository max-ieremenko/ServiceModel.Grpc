...
internal sealed class MessageMessagePackFormatter<T1, T2, T3> : IMessagePackFormatter<Message<T1, T2, T3>?>
{
#if DEBUG
    ...
    public void Serialize(ref MessagePackWriter writer, Message<T1, T2, T3>? value, MessagePackSerializerOptions options)
    {
#if DEBUG
    ...
    public Message<T1, T2, T3> Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
    {
#if DEBUG
        ...
        var result = new Message<T1, T2, T3>();
