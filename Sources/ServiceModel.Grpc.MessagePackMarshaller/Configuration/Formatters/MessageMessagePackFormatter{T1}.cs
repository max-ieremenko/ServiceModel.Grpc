...
internal sealed class MessageMessagePackFormatter<T1> : IMessagePackFormatter<Message<T1>?>
{
    ...
    public void Serialize(ref MessagePackWriter writer, Message<T1>? value, MessagePackSerializerOptions options)
    {
#if DEBUG
    ...
    public Message<T1> Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
    {
#if DEBUG
